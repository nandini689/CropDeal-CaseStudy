        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ErrorCausedAt = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAccnumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvoiceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DealerAccNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FarmerAccNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CropName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    CropType = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    CropQty = table.Column<int>(type: "int", nullable: false),
